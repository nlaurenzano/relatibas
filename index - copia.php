    ...
    <header id="first">
        <div class="header-content">
            <div class="inner">
                ...
                <!--<a href="#video-background" id="toggleVideo" data-toggle="collapse" class="btn btn-primary btn-x3">Video</a>-->
                
            </div>
        </div>
        <!--https://s3-us-west-2.amazonaws.com/coverr/poster/Traffic-blurred2.jpg-->
        <!--https://s3-us-west-2.amazonaws.com/coverr/mp4/Traffic-blurred2.mp4-->
        <!--
        <video autoplay="" loop="" class="fillWidth fadeIn wow collapse in" data-wow-delay="0.5s" poster="https://s3-us-west-2.amazonaws.com/coverr/poster/Traffic-blurred2.jpg" id="video-background">
            <source src="Traffic-blurred2.mp4" type="video/mp4">Su navegador no soporta tags de video. Sugerimos que actualice el navegador.
        </video>
        -->
    </header>
